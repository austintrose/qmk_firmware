...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_GRAVE,                                       KC_LBRACKET,    KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_TRANSPARENT,
    KC_TRANSPARENT, KC_A,           KC_S,           LGUI_T(KC_D),   LCTL_T(KC_F),   KC_G,                                                                           KC_H,           RCTL_T(KC_J),   RGUI_T(KC_K),   KC_L,           KC_SCOLON,      KC_TRANSPARENT,
    KC_TRANSPARENT, KC_Z,           KC_X,           KC_C,           LALT_T(KC_V),   KC_B,           KC_QUOTE,                                       KC_RBRACKET,    KC_N,           RALT_T(KC_M),   KC_COMMA,       KC_DOT,         KC_SLASH,       KC_TRANSPARENT,
